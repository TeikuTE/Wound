...
function AlanCh2({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    footnotes: /*#__PURE__*/React.createElement(FinderFootnotes, {
      notes: [{
        "n": 37,
        "text": "Rose talks like he has been waiting for me specifically. He has not. He has been waiting for whoever was next.",
        "act": 4,
        "late": false
      }]
    }),
    label: `CALIBRATION · p.${basePage + 2}`
  }, /*#__PURE__*/React.createElement(AlanBody, null, /*#__PURE__*/React.createElement("p", null, inline(`Stop pretending you're still human. You are a walking weapon. A living bomb on causality and a bona fide wound in space-time. Own it.`), /*#__PURE__*/React.createElement(FootnoteMarker, {
    n: 37,
    act: 4
    ...
    pageNum: basePage + 9,
    coordStamp: "[LOG // ENTRY_002]",
    label: `CALIBRATION · p.${basePage + 9}`
  })));
}
AlanCh2.pages = 10;
