  ...
  return (<>
    ...
    <Spread id="alan-2-02" label={"CALIBRATION · spread 2"}>
      ...
      <AlPage side="recto" runHead={"ENTRY_002"} pageNum={basePage + 3} coordStamp={"[LOG // ENTRY_002]"} label={`CALIBRATION · p.${basePage + 3}`}>
        ...
        <AlanBody><p>{inline(`Weaponized Once per session, when you generate Paradox through a roll, you may immediately convert it into a +1 bonus on your next DISRUPT roll. The contradiction becomes ammunition.`)}</p></AlanBody>
    ...
    <Spread id="alan-2-05" label={"CALIBRATION · spread 5"}>
      <AlPage side="verso" runHead={"ENTRY_002"} pageNum={basePage + 8} coordStamp={"[LOG // ENTRY_002]"} label={`CALIBRATION · p.${basePage + 8}`}>
        ...
        <AlanBody><p><b>{inline(`5. The Holding Action.`)}</b>{inline(` `)}<i>{inline(`Once per session, when you would suffer a consequence you cannot afford, declare The Holding Action. The consequence is delayed by exactly one scene. The Holding Action cannot be repeated until you have completed a Repreival.`)}</i></p></AlanBody>
