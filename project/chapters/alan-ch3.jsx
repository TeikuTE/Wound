...
function AlanCh3({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="alan-3-08" label={"OPERATIONAL PROCEDURES · spread 8"}>
      <AlPage side="verso" runHead={"ENTRY_003"} pageNum={basePage + 14} coordStamp={"[LOG // ENTRY_003]"} label={`OPERATIONAL PROCEDURES · p.${basePage + 14}`}>
      ...
      <AlPage side="recto" runHead={"ENTRY_003"} pageNum={basePage + 15} coordStamp={"[LOG // ENTRY_003]"} label={`OPERATIONAL PROCEDURES · p.${basePage + 15}`}>
