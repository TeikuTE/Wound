...
function AlanCh4({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    runHead: "ENTRY_004",
    pageNum: basePage + 2,
    coordStamp: "[LOG // ENTRY_004]",
    label: `FACTION PRESSURE · p.${basePage + 2}`
  ...
  }, inline(`PATTERN RECOGNITION (PARADOX 7+)`)), /*#__PURE__*/React.createElement("aside", {
    className: "al-fragment"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Sometimes the contamination rises faster than your analytical capacity drops. The gap is small and short, but while it lasts, you can see the next move before the timeline commits to it. Most Echoes do not survive long enough to develop it.`)), /*#__PURE__*/React.createElement("div", {
    className: "al-fragment__sign"
  }, "// AR")), /*#__PURE__*/React.createElement(AlanBody, null, /*#__PURE__*/React.createElement("p", null, inline(`Available when: `), /*#__PURE__*/React.createElement("b", null, inline(`Paradox 7+`)), inline(` and `), /*#__PURE__*/React.createElement("b", null, inline(`OBSERVE ≥+1`)), inline(`.`))), /*#__PURE__*/React.createElement(AlanBody, null, /*#__PURE__*/React.createElement("p", null, inline(`Once per session, declare: I see what's coming. State a specific complication (who/what, where, what it threatens). Mark 1 Coherence immediately. Mark the complication as BOUND. The Oracle must introduce it within the next 3 scenes, and when it arrives, you gain +2 to one roll taken in response.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "alan-4-03",
    label: "FACTION PRESSURE · spread 3"
  }, /*#__PURE__*/React.createElement(AlPage, {
    side: "verso",
    runHead: "ENTRY_004",
    pageNum: basePage + 4,
    coordStamp: "[LOG // ENTRY_004]",
    label: `FACTION PRESSURE · p.${basePage + 4}`
  }, /*#__PURE__*/React.createElement(AlanBody, null, /*#__PURE__*/React.createElement("p", null, inline(`If you reach Repreival before it appears, it still arrives anyway — upgraded one severity level — and you gain +1 Mutation from the strain of sustained prophetic perception.`))), /*#__PURE__*/React.createElement("aside", {
    className: "al-fragment"
  }, /*#__PURE__*/React.createElement("p", null, inline(`I've met two Echoes with maintained high-Paradox OBSERVE.`)), /*#__PURE__*/React.createElement("p", null, inline(`First one: stopped speaking in linear sentences. Everything was will happen / happened / happening. Grammatical tenses collapsed. Couldn't interact with anyone.`)), /*#__PURE__*/React.createElement("p", null, inline(`Second one: accurate predictions, perfect positioning. Survived 18 Crisis events through foreknowledge. Then predicted her own dissolution. Saw it coming for three weeks. Couldn't prevent it. Just watched it approach.`)), /*#__PURE__*/React.createElement("p", null, inline(`She chose Scionfall on day 17. Said waiting was worse than the end.`)), /*#__PURE__*/React.createElement("p", null, inline(`Prophecy doesn't make you safe. It makes you witness your own failure in advance.`)), /*#__PURE__*/React.createElement("div", {
    className: "al-fragment__sign"
  ...
  }, "Dr. Eleanor Chen // [DATE UNKNOWN]"), /*#__PURE__*/React.createElement("p", null, inline(`Landauer's principle: erasing a single bit of information requires a minimum amount of energy dissipated as heat. In CTH, the same is true at the level of identity. Scionfall promises mercy through cessation. The mercy is real. The thermodynamics are also real. Every Echo Scionfall walks gently into the silence releases a measurable amount of waveform energy back into the field. They are not just ending you. They are using you.`)))), /*#__PURE__*/React.createElement(AlPage, {
    side: "recto",
    runHead: "ENTRY_004",
    pageNum: basePage + 5,
    coordStamp: "[LOG // ENTRY_004]",
    label: `FACTION PRESSURE · p.${basePage + 5}`
  })));
}
AlanCh4.pages = 6;
