...
function AlanCh4({
  ...
  }, "Dr. Eleanor Chen // [DATE UNKNOWN]"), /*#__PURE__*/React.createElement("p", null, inline(`Landauer's principle: erasing a single bit of information requires a minimum amount of energy dissipated as heat. In CTH, the same is true at the level of identity. Scionfall promises mercy through cessation. The mercy is real. The thermodynamics are also real. Every Echo Scionfall walks gently into the silence releases a measurable amount of waveform energy back into the field. They are not just ending you. They are using you. — EC`)))), /*#__PURE__*/React.createElement(AlPage, {
    side: "recto",
    runHead: "ENTRY_004",
    pageNum: basePage + 5,
    coordStamp: "[LOG // ENTRY_004]",
