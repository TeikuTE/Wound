  ...
  return (<>
    ...
    <Spread id="alan-4-03" label={"FACTION PRESSURE · spread 3"}>
      <AlPage side="verso" runHead={"ENTRY_004"} pageNum={basePage + 4} coordStamp={"[LOG // ENTRY_004]"} label={`FACTION PRESSURE · p.${basePage + 4}`}>
        ...
        <aside className="al-chen-block" data-tier={tier}><div className="al-chen-block__head">Dr. Eleanor Chen // [DATE UNKNOWN]</div><p>{inline(`Landauer's principle: erasing a single bit of information requires a minimum amount of energy dissipated as heat. In CTH, the same is true at the level of identity. Scionfall promises mercy through cessation. The mercy is real. The thermodynamics are also real. Every Echo Scionfall walks gently into the silence releases a measurable amount of waveform energy back into the field. They are not just ending you. They are using you. — EC`)}</p></aside>
      </AlPage>
