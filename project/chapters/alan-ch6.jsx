...
function AlanCh6({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="alan-6-05" label={"TERMINAL CONFIGURATIONS · spread 5"}>
      <AlPage side="verso" runHead={"ENTRY_006"} pageNum={basePage + 8} coordStamp={"[LOG // ENTRY_006]"} footnotes={<FinderFootnotes notes={[{"n":49,"text":"He remembers two letters of a friend's name. I have stopped trying to remember Saul's. Maybe he was always mine.","act":5,"late":false}]} />} label={`TERMINAL CONFIGURATIONS · p.${basePage + 8}`}>
