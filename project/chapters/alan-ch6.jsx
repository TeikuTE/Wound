  ...
  return (<>
    ...
    <Spread id="alan-6-02" label={"TERMINAL CONFIGURATIONS · spread 2"}>
      <AlPage side="verso" runHead={"ENTRY_006"} pageNum={basePage + 2} coordStamp={"[LOG // ENTRY_006]"} label={`TERMINAL CONFIGURATIONS · p.${basePage + 2}`}>
        ...
        <FinderFootnotes notes={[{"n":47,"text":"Mirror this morning. No face. +3 DISRUPT where the face should be.","act":4,"late":false}]} />
      </AlPage>
    ...
    <Spread id="alan-6-05" label={"TERMINAL CONFIGURATIONS · spread 5"}>
      <AlPage side="verso" runHead={"ENTRY_006"} pageNum={basePage + 8} coordStamp={"[LOG // ENTRY_006]"} label={`TERMINAL CONFIGURATIONS · p.${basePage + 8}`}>
        ...
        <FinderFootnotes notes={[{"n":49,"text":"He remembers two letters of a friend's name. I have stopped trying to remember Saul's. Maybe he was always mine.","act":5,"late":false}]} />
      </AlPage>
