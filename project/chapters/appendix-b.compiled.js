...
function AppendixB({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-subsection"
  }, inline(`5. The Chronometric Stabilizer [Chrono-`))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Asset Catalogs",
    pageNum: basePage + 5,
    ...
    className: "el-list"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("b", null, inline(`Level 1 ○○○`)), inline(` — Allows one attempted Precision Navigation per session without spending Downtime. +1 to Navigation rolls.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "appendix-b-04",
    ...
    className: "el-list"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("b", null, inline(`Level 1 ○○○`)), inline(` — Always know exact date, time, and location. +1 Navigation. Sense Displacement 30 seconds before it occurs.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Asset Catalogs",
    pageNum: basePage + 7,
    ...
    className: "el-list"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("b", null, inline(`Level 2 ○○○○`)), inline(` — Speak any encountered language fluently. +2 SYNC. Read and write languages never studied. Understand subtext, idiom, and cultural context automatically.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Asset Catalogs",
    pageNum: basePage + 9,
    ...
    className: "el-list"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("b", null, inline(`Level 2 ○○○○`)), inline(` — Predict Paradox cascades. +2 OBSERVE. Once per session, spend 1 Coherence to prevent 1 Paradox from generating — you instinctively avoid the contradiction.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "appendix-b-07",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, inline(`Cost: each communication marks Stress.`)), inline(` The Connection becomes aware they exist across time — which has consequences.`))), /*#__PURE__*/React.createElement("aside", {
    className: "el-alan-block",
    "data-tier": tier
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Level 2 ○○○○ Introduce Origin Era knowledge to other timelines carefully. +2 OBSERVE or SYNC when teaching or sharing. +1 to Paradox reduction when working to minimize anachronistic contamination.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
