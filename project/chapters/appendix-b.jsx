  ...
  return (<>
    ...
    <Spread id="appendix-b-07" label={"ASSET CATALOGS · spread 7"}>
      <ChPage side="verso" runHead={"Asset Catalogs"} pageNum={basePage + 12} label={`ASSET CATALOGS · p.${basePage + 12}`}>
        ...
        <div className="el-body"><p>{inline(`Level 1 ○○○ Access Fading Memories with full clarity once per session without spending Coherence. +1 ENDURE when resisting memory loss.`)}</p></div>
    ...
    <Spread id="appendix-b-08" label={"ASSET CATALOGS · spread 8"}>
      <ChPage side="verso" runHead={"Asset Catalogs"} pageNum={basePage + 14} label={`ASSET CATALOGS · p.${basePage + 14}`}>
        ...
        <div className="el-body"><p><b>{inline(`Stress Effect: stored Paradox leaks. Reality`)}</b>{inline(` glitches. NPCs forget conversations mid- sentence.`)}</p></div>
    ...
    <Spread id="appendix-b-09" label={"ASSET CATALOGS · spread 9"}>
      <ChPage side="verso" runHead={"Asset Catalogs"} pageNum={basePage + 16} label={`ASSET CATALOGS · p.${basePage + 16}`}>
      ...
      <ChPage side="recto" runHead={"Asset Catalogs"} pageNum={basePage + 17} label={`ASSET CATALOGS · p.${basePage + 17}`}>
    ...
    <Spread id="appendix-b-10" label={"ASSET CATALOGS · spread 10"}>
      <ChPage side="verso" runHead={"Asset Catalogs"} pageNum={basePage + 18} label={`ASSET CATALOGS · p.${basePage + 18}`}>
        ...
        <div className="el-body"><p>{inline(`Level 2 ○○○○ Introduce Origin Era knowledge to other timelines carefully. +2 OBSERVE or SYNC when teaching or sharing. +1 to Paradox reduction when working to minimize anachronistic contamination.`)}</p></div>
      </ChPage>
      <ChPage side="recto" runHead={"Asset Catalogs"} pageNum={basePage + 19} label={`ASSET CATALOGS · p.${basePage + 19}`}>
        <div className="el-body"><p>{inline(`Level 3 ○○○○○ Manifest Origin Era knowledge as physical reality. +3 bonus. Once per session, create an object or technique from your home time that shouldn't exist in the current era — it lasts one scene, then fades.`)}</p></div>
