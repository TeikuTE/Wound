  ...
  return (<>
    ...
    <Spread id="appendix-e-01" label={"CAPTIVITY VIGNETTES · spread 1"}>
      <ChPage side="verso" runHead={"Captivity Vignettes"} pageNum={basePage + 0} label={`CAPTIVITY VIGNETTES · p.${basePage + 0}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Hold`)}</div><div className="resolution-text">{inline(`Reduce your Paradox by 1 (they harvest it). Lose 1 Coherence. You may attempt escape after 3 loops.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Weaken`)}</div><div className="resolution-text">{inline(`They harvest 1 Paradox. Lose 1`)}</div></div></div></div>
      ...
      <ChPage side="recto" runHead={"Captivity Vignettes"} pageNum={basePage + 1} label={`CAPTIVITY VIGNETTES · p.${basePage + 1}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Break free`)}</div><div className="resolution-text">{inline(`Templars release you —you're no longer useful. Take Scar: Phantom Screams.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Escape`)}</div><div className="resolution-text">{inline(`But they Mark you. They'll hunt you specifically next encounter.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Remain captured`)}</div><div className="resolution-text">{inline(`Three more loops. Then choose: automatic release (you're exhausted and useless), or undergo Lockstep Binding and become a Templar (character retired to NPC status).`)}</div></div></div></div>
    ...
    <Spread id="appendix-e-02" label={"CAPTIVITY VIGNETTES · spread 2"}>
      <ChPage side="verso" runHead={"Captivity Vignettes"} pageNum={basePage + 2} label={`CAPTIVITY VIGNETTES · p.${basePage + 2}`}>
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Notice the pattern`)}</div><div className="resolution-text">{inline(`You can attempt to break the loop. No memory loss this iteration.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Something's wrong`)}</div><div className="resolution-text">{inline(`Can't quite pin it down. Choose one Active Memory related to this scene — it becomes Fading.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Don't notice`)}</div><div className="resolution-text">{inline(`The loop feels natural. One`)}</div></div></div></div>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Break the loop`)}</div><div className="resolution-text">{inline(`Gain +3 Paradox. Loop shatters. You're free.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Partially break`)}</div><div className="resolution-text">{inline(`Released, but all memories from the looped scene are permanently Fading.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Fail`)}</div><div className="resolution-text">{inline(`Loop continues. Lose 1 Coherence from the iteration.`)}</div></div></div></div>
      ...
      <ChPage side="recto" runHead={"Captivity Vignettes"} pageNum={basePage + 3} label={`CAPTIVITY VIGNETTES · p.${basePage + 3}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Resist`)}</div><div className="resolution-text">{inline(`Maintain coherence through will or passion. No loss this round. Herald observes, patient.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Partially affected`)}</div><div className="resolution-text">{inline(`Lose 1 Coherence. One`)}</div></div></div></div>
    ...
    <Spread id="appendix-e-03" label={"CAPTIVITY VIGNETTES · spread 3"}>
      <ChPage side="verso" runHead={"Captivity Vignettes"} pageNum={basePage + 4} label={`CAPTIVITY VIGNETTES · p.${basePage + 4}`}>
      ...
      <ChPage side="recto" runHead={"Captivity Vignettes"} pageNum={basePage + 5} label={`CAPTIVITY VIGNETTES · p.${basePage + 5}`}>
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Navigate expertly`)}</div><div className="resolution-text">{inline(`Find a stable path. No cost.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Progress, but exposure`)}</div><div className="resolution-text">{inline(`Move toward escape but gain +1 Paradox.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Lost`)}</div><div className="resolution-text">{inline(`Lose `)}<b>{inline(`1d3`)}</b>{inline(` Coherence. No progress.`)}</div></div></div></div>
