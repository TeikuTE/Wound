...
function ChenCh1({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    pageNum: basePage + 2,
    label: `UNDERSTANDING DISPLACEME · p.${basePage + 2}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "el-body el-dropcap",
    "data-firstpara": true
  }, /*#__PURE__*/React.createElement("p", null, inline(`Time is an ocean. I know the river metaphor is older and more familiar, but set it down before we go any further, because the river is what kills new Echoes faster than anything else.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Rivers have banks, direction and flow. You can float in a river. Oceans have waves, predators and unfathomable depth. You can't float in the Chronoverse, and if you think that time will carry you forward, your existence will prove to be both finite and short.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`You've been Displaced — torn from normal temporal flow, drifting between historical eras, trying to hold yourself together as you do. What's left of you is called an Echo. As you travel, your memories will fade, erode, and distort. The question isn't whether that happens. It's which pieces go first, and who you are without them.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Temporal Echoes is a mediation on time travel, memory, and identity. It's played alone, with a journal, and it is not gentle.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
  }, inline(`What It Means to Be an Echo`)), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`You can't stay. I've watched Echoes try every version of permanence available to them. Marriages. Children. Foundations. None of it held for more than a generation. The era catches on. Sometimes within a year. Sometimes within forty. But never longer than that.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Your mind is finite; I wrote the mathematics that proved your memory capacity is quantifiable and limited. New experiences push old ones out at a rate that doesn't care how much you loved the old ones. Without active intervention, you'll forget what makes you yourself inside of fifty years. I'm sorry. That's the substrate we're working against.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Understanding Displacement",
    pageNum: basePage + 3,
    label: `UNDERSTANDING DISPLACEME · p.${basePage + 3}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-list"
  }, /*#__PURE__*/React.createElement("li", null, inline(`Can I return to my origin?`)), /*#__PURE__*/React.createElement("li", null, inline(`Should I preserve my original identity?`)), /*#__PURE__*/React.createElement("li", null, inline(`What happens if I forget who I was?`))), /*#__PURE__*/React.createElement(AlanIntrusionInline, {
    tier: tier
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Accepting their offers is drinking from a poisoned chalice. Rejecting their help is drowning in a poisoned pool.`))), /*#__PURE__*/React.createElement("aside", {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Two six-sided dice. Two ten-sided dice. A sturdy pen. You will write more than you expect to. And a journal, which I call your Chronicle throughout this manual.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Chronicling is not optional. It is the only thing standing between your current identity and total dissolution.`))), /*#__PURE__*/React.createElement(AlanIntrusionInline, {
    tier: tier
  }, /*#__PURE__*/React.createElement("p", null, inline(`Barrier, or tombstone? Depends what year you ask me.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
