...
function ChenCh2({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Kalamander Gravedigger came from a different place than Bob Karl. Write the name that feels like it was yours.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Excavating Your Echo",
    pageNum: basePage + 3,
  ...
  }, /*#__PURE__*/React.createElement("p", null, inline(`An Anchor is Pascal's wager carved into an object. You commit to a person, a place, a promise, in full knowledge that you cannot verify the bet. If they exist, you have something to come home to. If they do not, you have lost nothing as you were already lost. — EC`)), /*#__PURE__*/React.createElement("p", null, inline(`Your Anchor is your metaphysical connection to your origin — the reference frequency that keeps your waveform from dissolving completely into the timestream. It has two components.`)), /*#__PURE__*/React.createElement("div", {
    className: "el-sign"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Your Anchor isn't sentimental. It's structural. It's the baseline your waveform syncs with to prevent total decoherence. Treat it with the same precision you'd treat any other piece of equipment.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-2-04",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`You may adjust one Mode rating by 1 (up or down, minimum -1, maximum +3) when:`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Excavating Your Echo",
    pageNum: basePage + 9,
    ...
    className: "el-subsection"
  }, inline(`WHEN TWO TAGS COULD APPLY`)))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-2-07",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`PUSHING AN ASSET`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Excavating Your Echo",
    pageNum: basePage + 13,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`NPC Records`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`When an NPC who matters to you is in danger, you may take the hit for them. Describe your intervention, then choose one cost: lose 1 Coherence, gain +1 Paradox, or mark 2 Stress on any Asset. If you pay that cost, they survive — and they become a Recurring Thread.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-2-08",
