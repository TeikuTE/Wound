...
function ChenCh3({ tweaks, basePage = 1 }) {
  ...
  return (<>
    <Spread id="chen-3-opener" label="A SESSION OF PLAY · opener">
      ...
      <ChPage side="recto" showWatermark label="chen-3 · opener">
    ...
    <Spread id="chen-3-02" label="A SESSION OF PLAY · spread 2">
      ...
      <ChPage side="recto" runHead="A Session Of Play" pageNum={basePage + 3} label={`A SESSION OF PLAY · p.${basePage + 3}`}>
        ...
        <div className="el-body"><p>{inline(`Note: if the current situation resonates with a Memory strongly enough that the past is actively informing your present, you may be able to invoke it for a deeper bonus — see 'Temporal Echoes: When the Past Bleeds Through' in Chapter 5 for the full procedure.`)}</p></div>
