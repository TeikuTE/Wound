...
function ChenCh4({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    "data-firstpara": true
  }, /*#__PURE__*/React.createElement("p", null, inline(`When the outcome matters, you roll. Two six-sided dice, plus the relevant Mode, plus your Memory bonus if one applies.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Choose: Lose 1 Coherence OR Mark 1 Paradox`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 3,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Step 3: Roll `), /*#__PURE__*/React.createElement("b", null, inline(`2d6`)), inline(` + OBSERVE + Memory Bonus (if applicable).`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-03",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`After rolling all four Anomaly Tables, you may spend 1 Coherence to reroll one result. Choose which table to reroll (ERA, LOCATION, ANOMALY, or COMPLICATION), spend the Coherence, and accept the new result. You may do this once per displacement event.`))), /*#__PURE__*/React.createElement("aside", {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Crisis (-6) -2 to all Resolution rolls. Immediate Desynchronization Crisis.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 7,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Every time you are Displaced — voluntarily or not — you lose Coherence from the wrenching dislocation.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Involuntary jumps always cost 2. Crisis-level displacement costs 3. You don't get to choose when those happen. That's the point.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-05",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`A Church Templar successfully captures or touches you (their rituals target your origin frequency directly)`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Clear Anchor Stress during Downtime Step 2.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 9,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Change something small — redirect one person, save one life, +1 alter one decision`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Change something documented — an event with witnesses, +2 a death with records`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Meet yourself (any version — past, future, alternate) +2`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-06",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, inline(`Breach (10+)`)), inline(` — `), /*#__PURE__*/React.createElement("b", null, inline(`-2`)), inline(` to Resolution rolls. Timeline collapsing. Immediate Paradox Crisis. Faction Intervention during Crisis Phase 2.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 11,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`When an Agent appears at Paradox `), /*#__PURE__*/React.createElement("b", null, inline(`7-9`)), inline(`, they bring an Offer. The form varies — surveillance, interference, demand, or direct confrontation. Not every Agent encounter is a fight.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Offers are your non-roll path to Paradox relief. If Downtime moves aren't working, an Agent's trade is how you buy back control — by selling pieces of yourself.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "resolution-title"
  }, inline(`Success`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`You drive them off through violence or intimidation. No additional cost. They retreat. You're not Marked.`)))), /*#__PURE__*/React.createElement("div", {
    className: "resolution-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "resolution-roll"
  }, `7-9`), /*#__PURE__*/React.createElement("div", {
    ...
    className: "resolution-title"
  }, inline(`Success with cost`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`They retreat. Choose one: lose 2 Coherence, mark +1 Paradox, or they Mark you anyway.`)))), /*#__PURE__*/React.createElement("div", {
    className: "resolution-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "resolution-roll"
  }, `6-`), /*#__PURE__*/React.createElement("div", {
    ...
    className: "resolution-title"
  }, inline(`Failure`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`You fail. Take their Imposed consequence AND they Mark you. They leave when they're done with you.`))))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-08",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`If Refused: Impose — their prayer weighs on you, lose 1 Coherence. Mark — next Scout/Agent encounter is automatically Church.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The Offer: You're glitching. We can smooth you out. Become efficient again.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 15,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The Trade: Gain +2 Paradox now →Gain +3 to your next DISRUPT or OBSERVE roll only. Regardless of result, that roll triggers a Complication. Mark: they think you're interesting.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-09",
    ...
    className: "el-numlist"
  }, /*#__PURE__*/React.createElement("li", null, inline(`Reinforce Your Anchor.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-10",
    ...
    className: "el-numlist"
  }, /*#__PURE__*/React.createElement("li", null, inline(`Reduce Paradox (Optional).`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Answer one of these questions in your Chronicle: What am I trying to accomplish? What am I afraid will happen next? What do I need that I don't have?`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-11",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Your Lines and Veils can change between sessions. Cross things out. Add new ones. You are not locked in.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The game does not require completion. Your Echo does not lose Coherence because you put the book down. A session you stopped is a session. You can come back, or you can choose not to. Both are legal.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-12",
    label: "CORE RESOLUTION & FACTION PRESSURE · spread 12"
  }, /*#__PURE__*/React.createElement(ChPage, {
    side: "verso",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 22,
    label: `CORE RESOLUTION & FACTIO · p.${basePage + 22}`
  }, /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
