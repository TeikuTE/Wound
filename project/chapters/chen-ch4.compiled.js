...
function ChenCh4({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Offers are your non-roll path to Paradox relief. If Downtime moves aren't working, an Agent's trade is how you buy back control — by selling pieces of yourself.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-4-07",
    ...
    className: "resolution-text"
  }, inline(`You fail. Take their Imposed consequence AND they Mark you. They leave when they're done with you.`))))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The Trade: Take 1 Scar immediately + lose 2 Coherence →Reduce Paradox by 3. Mark: Church knows you're a viable battery. They'll return.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 13,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Your Lines and Veils can change between sessions. Cross things out. Add new ones. You are not locked in.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Core Resolution & Faction Pressure",
    pageNum: basePage + 19,
