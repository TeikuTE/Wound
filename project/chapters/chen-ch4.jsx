  ...
  return (<>
    ...
    <Spread id="chen-4-04" label={"CORE RESOLUTION & FACTION PRESSURE · spread 4"}>
      ...
      <ChPage side="recto" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 7} label={`CORE RESOLUTION & FACTIO · p.${basePage + 7}`}>
        ...
        <div className="el-body"><p>{inline(`A Church Templar successfully captures or touches you (their rituals target your origin frequency directly)`)}</p></div>
    ...
    <Spread id="chen-4-05" label={"CORE RESOLUTION & FACTION PRESSURE · spread 5"}>
      <ChPage side="verso" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 8} label={`CORE RESOLUTION & FACTIO · p.${basePage + 8}`}>
        ...
        <div className="el-body"><p>{inline(`Change something small — redirect one person, save one life, +1 alter one decision`)}</p></div>
        <div className="el-body"><p>{inline(`Change something documented — an event with witnesses, +2 a death with records`)}</p></div>
        ...
        <div className="el-body"><p>{inline(`Change something load-bearing — a battle's outcome, +3 a discovery's timing, a leader's survival`)}</p></div>
    ...
    <Spread id="chen-4-07" label={"CORE RESOLUTION & FACTION PRESSURE · spread 7"}>
      <ChPage side="verso" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 12} label={`CORE RESOLUTION & FACTIO · p.${basePage + 12}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`10+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Success`)}</div><div className="resolution-text">{inline(`You drive them off through violence or intimidation. No additional cost. They retreat. You're not Marked.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Success with cost`)}</div><div className="resolution-text">{inline(`They retreat. Choose one: lose 2 Coherence, mark +1 Paradox, or they Mark you anyway.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Failure`)}</div><div className="resolution-text">{inline(`You fail. Take their Imposed consequence AND they Mark you. They leave when they're done with you.`)}</div></div></div></div>
    ...
    <Spread id="chen-4-08" label={"CORE RESOLUTION & FACTION PRESSURE · spread 8"}>
      ...
      <ChPage side="recto" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 15} label={`CORE RESOLUTION & FACTIO · p.${basePage + 15}`}>
        ...
        <div className="el-body"><p>{inline(`At the end of your real-world play session, if neither of the above occurred.`)}</p></div>
        ...
        <ol className="el-numlist" start={2}><li>{inline(`Reinforce Your Anchor.`)}</li></ol>
        ...
        <ol className="el-numlist" start={3}><li>{inline(`Tend to Assets.`)}</li></ol>
      </ChPage>
    </Spread>
    <Spread id="chen-4-09" label={"CORE RESOLUTION & FACTION PRESSURE · spread 9"}>
      <ChPage side="verso" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 16} label={`CORE RESOLUTION & FACTIO · p.${basePage + 16}`}>
        ...
        <ol className="el-numlist" start={4}><li>{inline(`Process Memory.`)}</li></ol>
        ...
        <ol className="el-numlist" start={5}><li>{inline(`Reduce Paradox (Optional).`)}</li></ol>
      </ChPage>
      <ChPage side="recto" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 17} label={`CORE RESOLUTION & FACTIO · p.${basePage + 17}`}>
        ...
        <ol className="el-numlist" start={6}><li>{inline(`Plan Next Move.`)}</li></ol>
    ...
    <Spread id="chen-4-11" label={"CORE RESOLUTION & FACTION PRESSURE · spread 11"}>
      <ChPage side="verso" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 20} label={`CORE RESOLUTION & FACTIO · p.${basePage + 20}`}>
      ...
      <ChPage side="recto" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 21} label={`CORE RESOLUTION & FACTIO · p.${basePage + 21}`}>
