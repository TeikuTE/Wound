...
function ChenCh4({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="chen-4-12" label={"CORE RESOLUTION & FACTION PRESSURE · spread 12"}>
      <ChPage side="verso" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 22} label={`CORE RESOLUTION & FACTIO · p.${basePage + 22}`}>
      ...
      <ChPage side="recto" runHead={"Core Resolution & Faction Pressure"} pageNum={basePage + 23} label={`CORE RESOLUTION & FACTIO · p.${basePage + 23}`}>
