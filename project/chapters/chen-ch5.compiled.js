...
function ChenCh5({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Scars are identity consequences — psychological wounds gained when a Memory becomes Lost. Mutations are reality consequences — gained only from Paradox Breach (reaching 10+) or from explicit Mutation triggers in Faction interactions and Crisis outcomes.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 7,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Echo Bleed — You see brief overlays of other timelines. Strangers' faces flicker. Buildings appear half-demolished. You cannot always tell what is the present. Mechanically: -1 to OBSERVE when you have no Memory that applies to the current situation. The static fills the gap where context should be.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-5-05",
    ...
    className: "resolution-text"
  }, inline(`You recover a False Memory — a comforting lie that fills the gap. The Oracle decides what it is. You believe it completely. Gain a Scar: Beautiful Lie.`))))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-numlist"
  }, /*#__PURE__*/React.createElement("li", null, inline(`State the Memory — identify the specific Memory in your Chronicle.`)), /*#__PURE__*/React.createElement("li", null, inline(`Explain the Connection — how this past experience provides genuine insight into the current situation.`)), /*#__PURE__*/React.createElement("li", null, inline(`Gain the Bonus — apply the bonus based on the Memory's status (Active +2, Fading +1, Locked +3).`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-5-07",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`(No signature. No date. The handwriting changes halfway through.)`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 13,
