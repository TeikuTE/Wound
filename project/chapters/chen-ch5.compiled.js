...
function ChenCh5({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
  ...
  }, /*#__PURE__*/React.createElement("p", null, inline(`A Reed-Solomon code can reconstruct a corrupted message if enough of the parity blocks survive. Your Memories function the same way. As long as enough remain, the original message — You — can be reconstructed from the fragments.`)), /*#__PURE__*/React.createElement("div", {
    className: "el-sign"
  }, "\u2014 EC")), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Nine slots. Five Active. Three Fading. One Locked. The structure reflects what your nervous system was already doing before you were Displaced. You never remembered everything you lived. You remembered what was worth the metabolic cost of remembering.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Your memories exist in four states. They will not stay where you put them.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 3,
    ...
    className: "el-subsection"
  }, inline(`ACTIVE MEMORIES (5 SLOTS)`)), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Vivid, detailed, present in your mind. These provide +2 to matching actions. They're energetically expensive to maintain — high-amplitude waveforms with strong emotional mass. When you invoke an Active Memory for a bonus, you're literally harmonizing with your past self, using stored resonance to enhance your current action.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
  }, inline(`FADING MEMORIES (3 SLOTS)`)), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Losing clarity. +1 to matching actions. One step from being Lost. The signal is still there, but noise is increasing — new memories broadcasting on similar frequencies, creating static that obscures the old ones. The amplitude is decreasing. Chen's model calls this entropy. She's half right. It's also interference.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
  }, inline(`LOCKED MEMORY (1 SLOT)`)), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Permanently preserved. +3 to matching actions. Costs 3 Coherence to Lock. Cannot fade through normal means. You're spending tremendous energy to create a standing wave — a self-reinforcing pattern that resists entropy.`))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Locking is the most important choice you'll make. Choose a Memory that defines your core identity — something that, if lost, would mean you no longer recognize yourself. You can only Lock once.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-5-03",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Gone from conscious mind. No bonus. They leave Scars — narrative consequences, behavioral changes, the shape of what used to be there.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 5,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`You form roughly `), /*#__PURE__*/React.createElement("b", null, inline(`1-2`)), inline(` new Memories per session. The pressure to choose what matters is the game.`))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, inline(`False Story:`)), inline(` you've constructed a lie to fill the gap. You believe it. That's the dangerous part.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-5-04",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("i", null, inline(`MUTATIONS (TEMPORAL ECHOES)`))))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 7,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Permanently preserve one Active Memory. Can only be done once. Choose the core of your identity — the memory you would die before forgetting. Provides +3 bonus when invoked. Cannot fade through normal means.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 9,
  ...
  }, inline(`Against all odds, it returns`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`The Memory enters an Active slot, pushing all others down — this may force another Memory to become Fading. Gain +1 Paradox from the strain on causality.`)))), /*#__PURE__*/React.createElement("div", {
    className: "resolution-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "resolution-roll"
    ...
    className: "resolution-title"
  }, inline(`A fragment returns`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`The Memory comes back as Fading. You remember the shape of it, but not the texture. Gain +1 Paradox.`)))), /*#__PURE__*/React.createElement("div", {
    className: "resolution-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "resolution-roll"
    ...
    className: "resolution-title"
  }, inline(`The effort fails`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`Lose 1 additional Coherence. The Memory is gone. This attempt is the last time you'll look for it.`)))), /*#__PURE__*/React.createElement("div", {
    className: "resolution-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "resolution-roll"
    ...
    className: "resolution-title"
  }, inline(`The void stares back`)), /*#__PURE__*/React.createElement("div", {
    className: "resolution-text"
  }, inline(`You recover a False Memory — a comforting lie that fills the gap. The Oracle decides what it is. You believe it completely. Gain a Scar: Beautiful Lie.`))))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-5-06",
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("i", null, inline(`When the Past Bleeds Through`)))), /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Sometimes, in moments of Crisis or revelation, the weight of all your past experiences presses upon the present. A decision made centuries ago influences your actions now. This is not metaphor. This is CTH.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 11,
    ...
    id: "chen-5-07",
    label: "MEMORY MANAGEMENT · spread 7"
  }, /*#__PURE__*/React.createElement(ChPage, {
    side: "verso",
    runHead: "Memory Management",
    pageNum: basePage + 12,
    label: `MEMORY MANAGEMENT · p.${basePage + 12}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "el-body"
  ...
  }, /*#__PURE__*/React.createElement("p", null, inline(`The holographic principle holds that the information content of a volume of space can be encoded on its boundary. Your Chronicle is your boundary. What you write down is the surface from which your interior — your continuous self — can be reconstructed. If the volume is lost but the boundary remains, you can be rebuilt.`)), /*#__PURE__*/React.createElement("div", {
    className: "el-sign"
    ...
    className: "el-alan-sign"
  }, "\u2014AR")), /*#__PURE__*/React.createElement(Zaaken, null, /*#__PURE__*/React.createElement("i", null, inline(`Crisis.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Memory Management",
    pageNum: basePage + 13,
    label: `MEMORY MANAGEMENT · p.${basePage + 13}`
  })));
}
ChenCh5.pages = 14;
