  ...
  return (<>
    ...
    <Spread id="chen-5-05" label={"MEMORY MANAGEMENT · spread 5"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 8} label={`MEMORY MANAGEMENT · p.${basePage + 8}`}>
        ...
        <div className="el-body"><p><b>{inline(`12+`)}</b>{inline(` Against all odds, it returns. The Memory enters an Active slot, pushing all others down — this may force another Memory to become Fading. Gain +1 Paradox from the strain on causality.`)}</p></div>
