...
function ChenCh5({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="chen-5-03" label={"MEMORY MANAGEMENT · spread 3"}>
      ...
      <ChPage side="recto" runHead={"Memory Management"} pageNum={basePage + 5} footnotes={<FinderFootnotes notes={[{"n":22,"text":"This table is harder to read than the rest of the chapter. Like the book doesn't want me to look directly at it. Will note that and move on.","act":2,"late":false}]} />} label={`MEMORY MANAGEMENT · p.${basePage + 5}`}>
    ...
    <Spread id="chen-5-04" label={"MEMORY MANAGEMENT · spread 4"}>
      ...
      <ChPage side="recto" runHead={"Memory Management"} pageNum={basePage + 7} footnotes={<FinderFootnotes notes={[{"n":23,"text":"Started noticing little circle marks in Chen's margins next to certain mechanical terms. They look like physics notation. There's a key in Appendix A. Saving it for later.","act":2,"late":false}]} />} label={`MEMORY MANAGEMENT · p.${basePage + 7}`}>
        ...
        <table className="tbl-chen tbl-chen--oracle"><colgroup><col className="col-num"/><col className="col-name"/><col className="col-desc"/></colgroup><tbody><tr><td className="num">{`10-11`}</td><td className="oracle-name">{``}</td><td className="oracle-desc">{inline(`A fragment returns. The Memory comes back as Fading. You remember the shape of it, but not the texture. Gain +1 Paradox.`)}</td></tr></tbody></table>
      </ChPage>
    </Spread>
    <Spread id="chen-5-05" label={"MEMORY MANAGEMENT · spread 5"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 8} footnotes={<FinderFootnotes notes={[{"n":28,"text":"The Holding Action is the most honest mechanic in the book. You can refuse the consequence once. Once. Then the bill comes due. I have used it twice this week in real life.","act":3,"late":false}]} />} label={`MEMORY MANAGEMENT · p.${basePage + 8}`}>
        <table className="tbl-chen tbl-chen--oracle"><colgroup><col className="col-num"/><col className="col-name"/><col className="col-desc"/></colgroup><tbody><tr><td className="num">{`7-9`}</td><td className="oracle-name">{``}</td><td className="oracle-desc">{inline(`The effort fails. Lose 1 additional Coherence. The Memory is gone. This attempt is the last time you'll look for it.`)}</td></tr></tbody></table>
      ...
      <ChPage side="recto" runHead={"Memory Management"} pageNum={basePage + 9} footnotes={<FinderFootnotes notes={[{"n":24,"text":"This page is in Chen's voice but it reads like a confession. She did everything right and lost everything anyway. The Chronicle is becoming more than a journal. I am writing things in here I have never told anyone.","act":2,"late":false}]} />} label={`MEMORY MANAGEMENT · p.${basePage + 9}`}>
