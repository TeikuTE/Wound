...
function ChenCh5({ tweaks, basePage = 1 }) {
  ...
  return (<>
    <Spread id="chen-5-opener" label="MEMORY MANAGEMENT · opener">
      ...
      <ChPage side="recto" showWatermark label="chen-5 · opener">
    ...
    <Spread id="chen-5-03" label="MEMORY MANAGEMENT · spread 3">
      <ChPage side="verso" runHead="Memory Management" pageNum={basePage + 4} label={`MEMORY MANAGEMENT · p.${basePage + 4}`}>
        ...
        <div className="el-body"><p>{inline(`Phantom Habit: you perform a ritual you don't understand. The body`)}</p></div>
        <div className="el-body"><p>{inline(`remembers what the mind has lost.`)}</p></div>
        <div className="el-body"><p>{inline(`False Story: you've constructed a lie to fill the gap. You believe`)}</p></div>
      </ChPage>
      <ChPage side="recto" runHead="Memory Management" pageNum={basePage + 5} label={`MEMORY MANAGEMENT · p.${basePage + 5}`}>
        <div className="el-body"><p>{inline(`it. That's the dangerous part.`)}</p></div>
        <div className="el-body"><p>{inline(`Persistent Ache: physical pain tied to the loss. Location unknown.`)}</p></div>
        <div className="el-body"><p>{inline(`Cause unverifiable.`)}</p></div>
        <div className="el-body"><p>{inline(`Emotional Void: numbness where feeling used to be, or feeling where`)}</p></div>
        <div className="el-body"><p>{inline(`numbness would be appropriate.`)}</p></div>
        <div className="el-body"><p>{inline(`Behavioral Shift: a personality change, permanent. You act differently`)}</p></div>
        <div className="el-body"><p>{inline(`now. You may not have noticed yet.`)}</p></div>
    ...
    <Spread id="chen-5-05" label="MEMORY MANAGEMENT · spread 5">
      ...
      <ChPage side="recto" runHead="Memory Management" pageNum={basePage + 9} label={`MEMORY MANAGEMENT · p.${basePage + 9}`}>
        ...
        <div className="el-body"><p><i>{inline(`Temporal Echoes: When the Past Bleeds Through`)}</i></p></div>
