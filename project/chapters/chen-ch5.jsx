  ...
  return (<>
    ...
    <Spread id="chen-5-02" label={"MEMORY MANAGEMENT · spread 2"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 2} label={`MEMORY MANAGEMENT · p.${basePage + 2}`}>
        ...
        <FinderFootnotes notes={[{"n":20,"text":"Spent an hour today looking for an old photograph of my zayde. Wanted to see if it felt like an Anchor. It did. Heavier than a piece of paper should be.","act":2,"late":false}]} />
      </ChPage>
    ...
    <Spread id="chen-5-04" label={"MEMORY MANAGEMENT · spread 4"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 6} label={`MEMORY MANAGEMENT · p.${basePage + 6}`}>
        ...
        <FinderFootnotes notes={[{"n":22,"text":"This table is harder to read than the rest of the chapter. Like the book doesn't want me to look directly at it. Will note that and move on.","act":2,"late":false}]} />
      </ChPage>
    ...
    <Spread id="chen-5-05" label={"MEMORY MANAGEMENT · spread 5"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 8} label={`MEMORY MANAGEMENT · p.${basePage + 8}`}>
        ...
        <table className="tbl-chen tbl-chen--oracle"><tbody><tr><td className="num">{`10-11`}</td><td className="oracle-name">{``}</td><td className="oracle-desc">{inline(`A fragment returns. The Memory comes back as Fading. You remember the shape of it, but not the texture. Gain +1 Paradox.`)}</td></tr></tbody></table>
        <FinderFootnotes notes={[{"n":23,"text":"Started noticing little circle marks in Chen's margins next to certain mechanical terms. They look like physics notation. There's a key in Appendix A. Saving it for later.","act":2,"late":false}]} />
      </ChPage>
      <ChPage side="recto" runHead={"Memory Management"} pageNum={basePage + 9} label={`MEMORY MANAGEMENT · p.${basePage + 9}`}>
        <table className="tbl-chen tbl-chen--oracle"><tbody><tr><td className="num">{`7-9`}</td><td className="oracle-name">{``}</td><td className="oracle-desc">{inline(`The effort fails. Lose 1 additional Coherence. The Memory is gone. This attempt is the last time you'll look for it.`)}</td></tr></tbody></table>
    ...
    <Spread id="chen-5-06" label={"MEMORY MANAGEMENT · spread 6"}>
      <ChPage side="verso" runHead={"Memory Management"} pageNum={basePage + 10} label={`MEMORY MANAGEMENT · p.${basePage + 10}`}>
        ...
        <FinderFootnotes notes={[{"n":24,"text":"This page is in Chen's voice but it reads like a confession. She did everything right and lost everything anyway. The Chronicle is becoming more than a journal. I am writing things in here I have never told anyone.","act":2,"late":false}]} />
      </ChPage>
