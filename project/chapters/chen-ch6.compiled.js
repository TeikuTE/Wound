...
function ChenCh6({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Timeline contradictions reach critical mass. Trigger: Paradox reaches 10. Manifestation: roll on the Timeline Collapse table — history rewrites itself.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Crisis Management",
    pageNum: basePage + 3,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`(`), /*#__PURE__*/React.createElement("b", null, inline(`Difficulty 13`)), inline(`)`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Crisis Management",
    pageNum: basePage + 5,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`This roll uses your Locked Memory — if you have one, you must invoke it, adding its +3 bonus. This is the moment you locked it for. If you have no Locked Memory, you face the void without an anchor.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-6-04",
    ...
    className: "resolution-text"
  }, inline(`Quick Resolution: lose all Active Memories from the scene (become Fading), reduce Paradox by `), /*#__PURE__*/React.createElement("b", null, inline(`1d6`)), inline(`, loop releases you. Or play the Vignette (Appendix E: Loop Containment Protocol).`))))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-6-05",
    ...
    className: "resolution-text"
  }, inline(`Accept cessation (game ends peacefully), OR spend 3 Coherence + invoke Locked Memory to resist (gain Scar: Hollow Moments), OR play the Vignette (Appendix E: The Nullwave Protocol).`))))), /*#__PURE__*/React.createElement("h4", {
    className: "el-subsection"
    ...
    className: "resolution-text"
  }, inline(`Quick Resolution: lose `), /*#__PURE__*/React.createElement("b", null, inline(`1d6`)), inline(` Coherence, gain Scar: Probability Sight, Chronoclast loses interest. Or play the Vignette (Appendix E: Decoherence Bloom Survival).`)))))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Crisis Management",
    pageNum: basePage + 9,
