  ...
  return (<>
    ...
    <Spread id="chen-6-04" label={"CRISIS MANAGEMENT · spread 4"}>
      <ChPage side="verso" runHead={"Crisis Management"} pageNum={basePage + 6} label={`CRISIS MANAGEMENT · p.${basePage + 6}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Full stabilization`)}</div><div className="resolution-text">{inline(`Crisis ends. Restore some resources.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`10-11`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Partial stabilization`)}</div><div className="resolution-text">{inline(`Crisis ends but leaves a lasting consequence.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Barely survive`)}</div><div className="resolution-text">{inline(`Crisis ends but you suffer a major loss — Memory, Asset, or Anchor Strength.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Crisis consumes you`)}</div><div className="resolution-text">{inline(`Choose: Transform (retire Echo, become something else) or Dissolve (game over).`)}</div></div></div></div>
      ...
      <ChPage side="recto" runHead={"Crisis Management"} pageNum={basePage + 7} label={`CRISIS MANAGEMENT · p.${basePage + 7}`}>
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Full Stabilization`)}</div><div className="resolution-text">{inline(`You remember who you are. Crisis ends. Anchor Strength restored to 1. Gain Scar: Echo of Self — a permanent reminder of the time you almost stopped existing.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`10-11`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Partial Stabilization`)}</div><div className="resolution-text">{inline(`The Crisis ends, but you are permanently changed. Anchor Strength restored to 1. One of your Origin Details is permanently lost — you remember having a daughter, but not her face. You remember the lab, but not what you were trying to prove.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Barely Survive`)}</div><div className="resolution-text">{inline(`You stabilize, but the Anchor is gone. Anchor Strength remains at 0. You can no longer gain Coherence from Chronicling or Anchor Reinforcement. You are untethered. This is how Alan started.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Dissolution`)}</div><div className="resolution-text">{inline(`The final tether snaps. Your Echo dissolves into the timestream. Write your final Chronicle entry as fragments — not sentences, just images and half-words, fading at the edges. Then close the book.`)}</div></div></div></div>
    ...
    <Spread id="chen-6-05" label={"CRISIS MANAGEMENT · spread 5"}>
      <ChPage side="verso" runHead={"Crisis Management"} pageNum={basePage + 8} label={`CRISIS MANAGEMENT · p.${basePage + 8}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Fight them off`)}</div><div className="resolution-text">{inline(`Gain +2 Paradox from the violence. They retreat.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Escape but wounded`)}</div><div className="resolution-text">{inline(`Lose 3 Coherence OR mark all Stress on one Asset.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Captured`)}</div><div className="resolution-text">{inline(`Quick Resolution: suffer 1 Scar, lose 2 Coherence, reduce Paradox by 3, released. Or play the Vignette (Appendix E: Harmonic Crucifixion).`)}</div></div></div></div>
      ...
      <ChPage side="recto" runHead={"Crisis Management"} pageNum={basePage + 9} label={`CRISIS MANAGEMENT · p.${basePage + 9}`}>
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Notice the pattern immediately`)}</div><div className="resolution-text">{inline(`Break the loop before it stabilizes. No cost.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Trapped for `)}<b>{inline(`1d6`)}</b>{inline(` iterations`)}</div><div className="resolution-text">{inline(`Each iteration, one Active Memory becomes Fading. Then escape.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Fully looped`)}</div><div className="resolution-text">{inline(`Quick Resolution: lose all Active Memories from the scene (become Fading), reduce Paradox by `)}<b>{inline(`1d6`)}</b>{inline(`, loop releases you. Or play the Vignette (Appendix E: Loop Containment Protocol).`)}</div></div></div></div>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Resist through sheer emotional intensity`)}</div><div className="resolution-text">{inline(`Generate +3 Paradox to disrupt Nullwave. Herald withdraws.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Partially affected`)}</div><div className="resolution-text">{inline(`Lose 2 Coherence, one Fading Memory becomes Lost. Herald offers one more time, then leaves.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Succumbing`)}</div><div className="resolution-text">{inline(`Accept cessation (game ends peacefully), OR spend 3 Coherence + invoke Locked Memory to resist (gain Scar: Hollow Moments), OR play the Vignette (Appendix E: The Nullwave Protocol).`)}</div></div></div></div>
      </ChPage>
    </Spread>
    <Spread id="chen-6-06" label={"CRISIS MANAGEMENT · spread 6"}>
      <ChPage side="verso" runHead={"Crisis Management"} pageNum={basePage + 10} label={`CRISIS MANAGEMENT · p.${basePage + 10}`}>
        ...
        <div className="el-body"><p>{inline(`Roll `)}<b>{inline(`2d6`)}</b>{inline(` + OBSERVE (`)}<b>{inline(`Difficulty 10`)}</b>{inline(`):`)}</p></div>
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Navigate the chaos expertly`)}</div><div className="resolution-text">{inline(`Chronoclast applauds. They give you an unstable Asset of your choice.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Escape but contaminated`)}</div><div className="resolution-text">{inline(`Gain +2 Paradox, suffer -1 Coherence from exposure.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Lost in decoherence`)}</div><div className="resolution-text">{inline(`Quick Resolution: lose `)}<b>{inline(`1d6`)}</b>{inline(` Coherence, gain Scar: Probability Sight, Chronoclast loses interest. Or play the Vignette (Appendix E: Decoherence Bloom Survival).`)}</div></div></div></div>
      ...
      <ChPage side="recto" runHead={"Crisis Management"} pageNum={basePage + 11} label={`CRISIS MANAGEMENT · p.${basePage + 11}`}>
        ...
        <div className="el-resolution"><div className="resolution-row"><div className="resolution-roll">{`12+`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Full stabilization`)}</div><div className="resolution-text">{inline(`Both Crises end. Restore 2 Coherence and reduce Paradox by 2.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`10-11`}</div><div className="resolution-body"><div className="resolution-title">{inline(`One Crisis resolves; the other lingers`)}</div><div className="resolution-text">{inline(`Choose which. The lingering one triggers again at the start of your next session.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`7-9`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Barely survive`)}</div><div className="resolution-text">{inline(`Choose two from: lose a Memory, lose an Asset, reduce Anchor Strength by 1, gain a Mutation.`)}</div></div></div><div className="resolution-row"><div className="resolution-roll">{`6-`}</div><div className="resolution-body"><div className="resolution-title">{inline(`Dissolution or Terminal Transformation`)}</div><div className="resolution-text">{inline(`No partial options.`)}</div></div></div></div>
    ...
    <Spread id="chen-6-07" label={"CRISIS MANAGEMENT · spread 7"}>
      <ChPage side="verso" runHead={"Crisis Management"} pageNum={basePage + 12} label={`CRISIS MANAGEMENT · p.${basePage + 12}`}>
      ...
      <ChPage side="recto" runHead={"Crisis Management"} pageNum={basePage + 13} label={`CRISIS MANAGEMENT · p.${basePage + 13}`}>
