  ...
  return (<>
    ...
    <Spread id="chen-6-03" label={"CRISIS MANAGEMENT · spread 3"}>
      ...
      <ChPage side="recto" runHead={"Crisis Management"} pageNum={basePage + 5} label={`CRISIS MANAGEMENT · p.${basePage + 5}`}>
        <table className="tbl-chen tbl-chen--oracle"><colgroup><col className="col-num"/><col className="col-name"/><col className="col-desc"/></colgroup><tbody><tr><td className="num">{`7-9`}</td><td className="oracle-name">{``}</td><td className="oracle-desc">{inline(`Barely Survive. You stabilize, but the Anchor is gone. Anchor Strength remains at 0. You can no longer gain Coherence from Chronicling or Anchor Reinforcement. You are untethered. This is how Alan started.`)}</td></tr></tbody></table>
