...
function ChenCh8({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The more you interfere, the more unstable your surroundings: anachronisms appearing, people remembering multiple versions of events, physical impossibilities manifesting, other Echoes drawn to your disturbance.`)))), /*#__PURE__*/React.createElement(ChPage, {
    side: "recto",
    runHead: "Long-Term Play",
    pageNum: basePage + 5,
    ...
    className: "el-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Coherence cannot be restored. Identity too fragmented. Final Chronicle entry: fragments, then silence.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "chen-8-04",
