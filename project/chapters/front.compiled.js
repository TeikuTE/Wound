...
function FrontMatter({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`First Edition, 2025 · ©2026 All Rights Reserved temporalechoesgame@gmail.com`))), /*#__PURE__*/React.createElement("div", {
    className: "al-rule",
    "aria-hidden": true
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`During the first seven months after my wife had given birth, we were in a constant struggle for survival. Visiting specialists whose titles I couldn't pronounce, never sleeping more than an hour at a time because every time he wakes up is an opportunity to get some more calories in. Fighting with feeding trackers and hollowing ourselves out, day by day, while we wondered what was wrong with our kid and why no one had an answer.`)))), /*#__PURE__*/React.createElement(IlPage, {
    side: "recto",
    showTexture: false,
    pageNum: basePage + 1,
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Getting to the hospital was a relief, in a way. It meant the cavalry had arrived and we could — well, not relax, but finally let an adult figure out what was going on. Turns out, our kid had an ultra-rare lung disease. Only about a thousand babies in the world have it. He'd need a feeding tube and twenty-four-hour oxygen — but he'd be alright in the long run.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`I lost my tefillin. If you know you know. Between my kid's health issues, the pressures of my job, and my newfound inability to connect with God in the way I'd done for over two decades, I finally crumpled. I sat down in my office's wellness room — reserved for nursing mothers, but I didn't care — and cried like my baby couldn't.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "front-02",
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`If you're reading this, it means you found this copy. If you're holding it in your hands — be careful what you write in the margins. The book remembers.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`I didn't know then that the two voices arguing in those pages had once been something like friends. Something like allies. They shared a moment I've only glimpsed in fragments — a night in 1944, a burning building, a choice that broke four people into the four philosophies that now hunt each other across the timestream.`))), /*#__PURE__*/React.createElement("aside", {
    className: "il-voice il-voice--chen"
  }, /*#__PURE__*/React.createElement("p", null, inline(`The year is wrong. He has it from a fragment of Alan's that drifted loose. He needs the date he has.`)), /*#__PURE__*/React.createElement("div", {
    className: "il-voice__sign"
  }, "\u2014 Dr. Chen")), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`They call it the First Scar.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Dr. Chen won't speak of it. Alan mentions it only to wound. The other two — you'll meet their echoes later — have become something else entirely.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`I'm telling you this not because it explains the rules. It doesn't. It explains the grief.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`This game came out of that room.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`A note on what follows.`)))), /*#__PURE__*/React.createElement(IlPage, {
    side: "recto",
    showTexture: false,
    pageNum: basePage + 3,
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`I tried to transcribe both manuscripts the way I found them. Chen's writing was neat and orderly but Alan's was a hot mess. His pages came out of order, some in pencil, gone over in pen later. Most were pages from old IBM style terminal printout style which doesn't make any sense considering when he says he lives.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`This "book" is incomplete. Pages were torn from Alan's manuscript before I got them. At least a couple of Chen's pages had scorch marks on top of the text. I don't know the full context (I am sure neither of them would have used dice or pens) but my guess it was both of their manuals were meant to train echoes. I read them both as a little guilty, but who knows. I did the best I could, caveat lector.`))), /*#__PURE__*/React.createElement("aside", {
    className: "il-voice il-voice--alan"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Doesn't need to be accurate to be true.`)), /*#__PURE__*/React.createElement("div", {
    className: "il-voice__sign"
  }, "\u2014 A. Rose")), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Temporal Echoes is designed for progressive complexity. Do not read it cover to cover. You will be overwhelmed and you will quit. Read in stages.`))), /*#__PURE__*/React.createElement("h4", {
    className: "interlude-eyebrow"
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Chapter 6: Crisis Management Chapter 7: Advanced Systems Faction Profiles (Appendix D) The universe has noticed you. Now you need the rules of engagement.`)))), /*#__PURE__*/React.createElement(IlPage, {
    side: "recto",
    showTexture: false,
    pageNum: basePage + 5,
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`That's it. You've played your first session. The Factions, the Crises, the full Navigation system — they'll find you when you're ready. You don't need to understand the whole ocean. You just need to survive this wave.`))))), /*#__PURE__*/React.createElement(Spread, {
    id: "front-04",
    label: "FRONT MATTER · spread 4"
  }, /*#__PURE__*/React.createElement(IlPage, {
    side: "verso",
    showTexture: false,
    pageNum: basePage + 6,
    label: `FRONT MATTER · p.${basePage + 6}`
  }, /*#__PURE__*/React.createElement("h4", {
    className: "interlude-eyebrow"
  }, inline(`DOCUMENT STRUCTURE`)), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Book 1: Temporal Echoes (Chapters 1-8) Dr. Eleanor Chen's preservation manual.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  ...
  }, /*#__PURE__*/React.createElement("i", null, inline(`Hoc fit, ergo diligenter lege.`)))), /*#__PURE__*/React.createElement(IlPage, {
    side: "recto",
    showTexture: false,
    pageNum: basePage + 7,
    label: `FRONT MATTER · p.${basePage + 7}`
  })));
}
FrontMatter.pages = 8;
