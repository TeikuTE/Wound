...
function FrontMatter({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Spread, {
    ...
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`During the first seven months after my wife had given birth, we were in a constant struggle for survival. Visiting specialists whose titles I couldn't pronounce, never sleeping more than an hour at a time because every time he wakes up is an opportunity to get some more calories in. Fighting with feeding trackers and hollowing ourselves out, day by day, while we wondered what was wrong with our kid and why no one had an answer.`))), /*#__PURE__*/React.createElement("div", {
    className: "interlude-body"
  }, /*#__PURE__*/React.createElement("p", null, inline(`Getting to the hospital was a relief, in a way. It meant the cavalry had arrived and we could — well, not relax, but finally let an adult figure out what was going on. Turns out, our kid had an ultra-rare lung disease. Only about a thousand babies in the world have it. He'd need a feeding tube and twenty-four-hour oxygen — but he'd be alright in the long run.`)))), /*#__PURE__*/React.createElement(IlPage, {
    side: "recto",
    showTexture: false,
    pageNum: basePage + 1,
