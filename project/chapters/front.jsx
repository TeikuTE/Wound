...
function FrontMatter({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="front-01" label={"FRONT MATTER · spread 1"}>
      ...
      <IlPage side="recto" showTexture={false} pageNum={basePage + 1} footnotes={<FinderFootnotes notes={[{"n":3,"text":"Oh. He's frum. He's frum and he lost his tefillin in the wellness room. I have read three lines past that sentence five times. Going to make tea.","act":1,"late":false},{"n":4,"text":"Most metal opening sentence in a TTRPG manual since Cy_Borg. We are cooking.","act":1,"late":false},{"n":57,"text":"I was already an Echo when I picked it up.","act":5,"late":true}]} />} label={`FRONT MATTER · p.${basePage + 1}`}>
