...
function FrontMatter({ tweaks, basePage = 1 }) {
  ...
  return (<>
    ...
    <Spread id="front-01" label={"FRONT MATTER · spread 1"}>
      <IlPage side="verso" showTexture={false} pageNum={basePage + 0} footnotes={<FinderFootnotes notes={[{"n":2,"text":"He's writing about the NICU and I'm reading it in the same chair I sat in three months ago waiting for my own kid's blood work. Bad time to start this book. Doing it anyway.","act":1,"late":false}]} />} label={`FRONT MATTER · p.${basePage + 0}`}>
        ...
        <div className="interlude-body"><p>{inline(`temporalechoesgame@gmail.com`)}</p></div>
        ...
        <div className="interlude-body"><p>{inline(`During the first seven months after my wife had given birth, we were in a constant struggle for survival. Visiting specialists whose titles I couldn't pronounce, never sleeping more than an hour at a time because every time he wakes up is an opportunity to get some more calories in. Fighting with feeding trackers and hollowing ourselves out, day by day, while we wondered what was wrong with our kid and why no one had an answer.`)}<FootnoteMarker n={2} act={1} /></p></div>
      </IlPage>
      <IlPage side="recto" showTexture={false} pageNum={basePage + 1} footnotes={<FinderFootnotes notes={[{"n":3,"text":"Oh. He's frum. He's frum and he lost his tefillin in the wellness room. I have read three lines past that sentence five times. Going to make tea.","act":1,"late":false}]} />} label={`FRONT MATTER · p.${basePage + 1}`}>
        ...
        <div className="interlude-body"><p>{inline(`I lost my tefillin. If you know you know. Between my kid's health issues, the pressures of my job, and my newfound inability to connect with God in the way I'd done for over two decades, I finally crumpled. I sat down in my office's wellness room — reserved for nursing mothers, but I didn't care — and cried like my baby couldn't.`)}<FootnoteMarker n={3} act={1} /></p></div>
    ...
    <Spread id="front-02" label={"FRONT MATTER · spread 2"}>
      <IlPage side="verso" showTexture={false} pageNum={basePage + 2} footnotes={<FinderFootnotes notes={[{"n":4,"text":"Most metal opening sentence in a TTRPG manual since Cy_Borg. We are cooking.","act":1,"late":false},{"n":57,"text":"I was already an Echo when I picked it up.","act":5,"late":true}]} />} label={`FRONT MATTER · p.${basePage + 2}`}>
        <div className="interlude-body"><p>{inline(`If you're reading this, it means you found this copy. If you're holding it in your hands — be careful what you write in the margins. The book remembers.`)}<FootnoteMarker n={4} act={1} /><FootnoteMarker n={57} act={5} /></p><span className="gly-inline-row"><Glyph name="null" size="inline" stage={0} /></span></div>
      ...
      <IlPage side="recto" showTexture={false} pageNum={basePage + 3} footnotes={<FinderFootnotes notes={[{"n":5,"text":"A bit pretentious. Going to play along. Starting with Anachron and seeing if I can keep an Echo intact.","act":1,"late":false}]} />} label={`FRONT MATTER · p.${basePage + 3}`}>
        ...
        <div className="interlude-body"><p>{inline(`Temporal Echoes is designed for progressive complexity. Do not read it cover to cover. You will be overwhelmed and you will quit. Read in stages.`)}<FootnoteMarker n={5} act={1} /></p></div>
      </IlPage>
    </Spread>
    <Spread id="front-03" label={"FRONT MATTER · spread 3"}>
      ...
      <IlPage side="recto" showTexture={false} pageNum={basePage + 5} footnotes={<FinderFootnotes notes={[{"n":6,"text":"Eight appendices for a \"first 3 sessions\" game. The author needs a Reduction phase. Structure is solid though.","act":1,"late":false}]} />} label={`FRONT MATTER · p.${basePage + 5}`}>
        ...
        <div className="interlude-body"><p>{inline(`Book 1: Temporal Echoes (Chapters 1-8) Dr. Eleanor Chen's preservation manual.`)}<FootnoteMarker n={6} act={1} /></p></div>
